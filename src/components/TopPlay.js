...
const TopChartCard = ({ data, song, i, isPlaying, activeSong, handlePauseClick }) => {
...
const TopPlay = () => {
  ...
  const topPlays = dataSong?.slice(0, 5); 
    ...
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          <h2 className="text-white font-bold text-2xl">Top shart play</h2>
          <Link to="/top-charts">
